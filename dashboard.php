...
<head>
    ...
    <style>
        body,
        .menubar-left.menubar-unfold.menubar-light.theme-primary {
        ...
        .widget.stats-widget .widget-body {
            padding: 15px;
            border-bottom: 1px solid #f5f5f5;
        }

        .widget.stats-widget .widget-title {
            font-size: 24px;
            margin-bottom: 10px;
        }

        .widget.stats-widget small.text-color {
            color: #999;
        }

        .widget.stats-widget .big-icon.watermark i {
            font-size: 48px;
            color: #ccc;
        }

        .widget.stats-widget footer.widget-footer {
            padding: 5px;
        }

        .widget.stats-widget a {
            color: #fff;
            text-decoration: none;
        }

        .widget.stats-widget .small-chart.pull-right {
            width: 40px;
            height: 30px;
            display: inline-block;
        }

        .widget.stats-widget .widget-footer.bg-warning {
            background-color: #f8ac59;
        }

        .widget.stats-widget .widget-footer.bg-success {
            background-color: #1ab394;
        }

        .widget.stats-widget .widget-footer.bg-danger {
            background-color: #ed5565;
        }

        .widget.stats-widget .widget-footer.bg-primary {
        ...
        <div class="widget-body clearfix">
            <div class="pull-left">
                ...
                <h3 class="widget-title text-primary"><span class="counter"
                                                           data-plugin="counterUp"><?php echo htmlentities($totapt); ?></span>
                </h3>
