            ...
            <section class="gallery">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-3 ps-0">
                            <img src="images/gallery/22.jpg" class="img-fluid galleryImage" alt="get a vaccine" title="Time and health are two 
                            precious assets that 
                            we don't recognize and appreciate 
                            until they have been depleted.">
                        </div>

                        <div class="col-lg-3 col-3 pe-0">
                            <img src="images/gallery/23.jpg" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
                        <div class="col-lg-3 col-3 pe-0">
                            <img src="images/gallery/25.jpg" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
                        <div class="col-lg-3 col-3 ps-0">
                            <img src="images/gallery/21.jpg" class="img-fluid galleryImage" alt="get a vaccine" title="Time and health are two 
                            precious assets that 
                            we don't recognize and appreciate 
                            until they have been depleted.">
                        </div>
